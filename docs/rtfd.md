...
By default, the [puppet-syslog](https://github.com/ULHPC/puppet-syslog) repository is bound to the [ulhpc-puppet-syslog](http://ulhpc-puppet-syslog.rtfd.org) project on Read the Docs (to avoid confusion with other syslog projects). 
